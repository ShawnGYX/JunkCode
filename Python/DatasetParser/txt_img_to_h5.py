...
def extract_txt(sensor_size, ep, img_cnt, txt_path, output_path, zero_timestamps=False,
    ...
    ep.add_metadata(total_num_pos, total_num_neg, last_ts-t0, t0, last_ts, img_cnt, num_flow=0, sensor_size=sensor_size)
...
if __name__ == "__main__":
    ...
    extract_txt_imgs(sensor_size, img_txt_paths, img_paths, txt_paths, args.output_dir, zero_timestamps=args.zero_timestamps)
